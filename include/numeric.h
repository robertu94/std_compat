 ...
 */
#ifndef STDCOMPAT_NUMERIC_H
#define STDCOMPAT_NUMERIC_H
...
#if (!STDCOMPAT_HAS_TRANSFORM_REDUCE)
  /**
...
#if (!STDCOMPAT_HAS_EXCLUSIVE_SCAN)
/**
...
#endif /* end of include guard: STDCOMPAT_NUMERIC_H
 */
